...
{% hint style="info" %}
### [**Download SWAT+ Installer 1.1.0**](https://plus.swat.tamu.edu/downloads/swatplustools-installer-1.1.0.zip)

Windows 64 bit  
Includes SWAT+ rev. 59, QSWAT+ 1.0.0, SWAT+ Editor 1.1.0, and SWAT+ databases  
