...
## 2. SWAT+ 2.0.1 Installer

This release includes **SWAT+ rev. 60.5.2**, **QSWAT+ 2.0.5**, and **SWAT+ Editor 2.0.1**. To install the SWAT+ model and interface components, please use an installer linked below for your operating system. The installer is for 64-bit machines. Administrator privileges are not required.
