---
description: SWAT+ Editor 1.2.3 with QSWAT+ 1.2.2 and SWAT+ revision 59.3
---
...
* Fixed bug in writing aqu\_catunit.ele where basin fraction would be 0 for small areas
...
* When writing inputs, changed bsn\_frac column to exponential format for better precision
