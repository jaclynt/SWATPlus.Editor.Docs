...
If you encounter an error, check the box to run the debug version and run the model again. Copy the contents of the output error and [see our SWAT+ model user group](../../get-help/) for help diagnosing the problem.
